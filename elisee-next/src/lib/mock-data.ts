...
export const MOCK_PRODUCTS: MockProduct[] = [
  {
    ...
    images: {
      edges: [
        { node: { url: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=500&q=80' } },
      ],
    },
    options: [
  ...
  },
  {
    ...
    images: {
      edges: [
        { node: { url: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&w=500&q=80' } },
      ],
    },
    options: [
  ...
  },
  {
    ...
    images: {
      edges: [
        { node: { url: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=500&q=80' } },
      ],
    },
  ...
  },
  {
    ...
    images: {
      edges: [
        { node: { url: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=500&q=80' } },
      ],
    },
...
export const MOCK_CUSTOMERS: unknown[] = [];
